...
**Dashboard** — Open `http://localhost:3000` (requires [Dev Mode](/getting-started/dev-mode/)) for real-time visualization of war-rooms, channels, and the DAG.
...
- Learn about the [Zero-Agent Pattern](/concepts/zero-agent/) and how agents are composed at runtime
