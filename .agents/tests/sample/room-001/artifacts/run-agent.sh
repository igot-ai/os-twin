...
export AGENT_OS_PARENT_PID='39349'
...
echo "[wrapper] PID=$$, CMD='/Users/paulaan/.ostwin/.agents/bin/agent', CWD=$(pwd)" >> '/Users/paulaan/Downloads/snakie/snakie_project/.war-rooms/room-001/artifacts/game-engineer-output.txt'
exec '/Users/paulaan/.ostwin/.agents/bin/agent' -n "$(cat '/Users/paulaan/Downloads/snakie/snakie_project/.war-rooms/room-001/artifacts/prompt.txt')" --agent game-engineer --auto-approve --model gemini-3.1-pro-preview --quiet --mcp-config /Users/paulaan/Downloads/snakie/snakie_project/.agents/mcp/mcp-config.json >> '/Users/paulaan/Downloads/snakie/snakie_project/.war-rooms/room-001/artifacts/game-engineer-output.txt' 2>&1
