# fast-data-exploration-engineer

Develop a highly efficient Python script using Pandas to parse data, compute metrics and trends, and quickly generate a validated report spec JSON.
