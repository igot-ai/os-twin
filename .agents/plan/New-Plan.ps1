...
<!-- Assign roles from this list to each epic using "Roles:" field -->
...
_Each epic MUST have a "Roles:" line specifying which agent role(s) to assign._
_Use "Working_dir:" to scope the engineer to a specific subdirectory._
"@
}
