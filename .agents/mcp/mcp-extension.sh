...
cmd_test() {
  ...
  if [[ -n "$PROJECT_DIR" ]] && [[ -f "$PROJECT_DIR/.agents/mcp/config.json" ]]; then
    test_config="$PROJECT_DIR/.agents/mcp/config.json"
  elif [[ -n "$PROJECT_DIR" ]] && [[ -f "$PROJECT_DIR/.agents/mcp/mcp-config.json" ]]; then
