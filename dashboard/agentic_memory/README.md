...
- [`retrievers.py`](retrievers.py): lớp truy hồi vector bằng Zvec
...
Điểm hay trong implementation hiện tại là khi lưu vào Zvec, hệ thống không embed mỗi nội dung thô. Nó tạo một `enhanced_document` gồm:
...
- Zvec là nơi phục vụ truy hồi semantic
...
6. `ZvecRetriever` trong [`retrievers.py`](retrievers.py)
