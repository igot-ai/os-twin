...
from dashboard.routes import auth, engagement, plans, rooms, system, mcp, skills, roles, memory, channels, chat_adapters, agent
...
app.include_router(chat_adapters.router)
