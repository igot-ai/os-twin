...
Implement the core Next.js design system, migrate TailwindCSS locally, define theme tokens, load required fonts, and build the shared UI component library.
