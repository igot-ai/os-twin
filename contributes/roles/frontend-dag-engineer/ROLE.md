# frontend-dag-engineer

Build a simplified React-based SVG Directed Acyclic Graph (DAG) visualization component to display EPIC dependencies with interactive nodes, edges, and a navigation toolbar.
