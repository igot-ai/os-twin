# nextjs-mock-api-engineer

Create a complete Next.js API route layer, expand in-memory mock data, and build type-safe SWR hooks to serve as a frontend backend substitute.
