# frontend-layout-engineer

Build the persistent application shell, including the Next.js layout, CSS Grid app shell, sticky top bar, and collapsible sidebar with local storage persistence.
